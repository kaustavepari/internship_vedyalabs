...
const ChartContainer: React.FC<ChartContainerProps> = ({ chartType }) => {
  if (chartType.startsWith("line")) {
    return <LineChart data={trafficVolume} chartType={chartType} />;
  }
  
  return <BarChart data={trafficVolume} chartType={chartType} />;
};
